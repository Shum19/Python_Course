...
# что у вашей звезды таких планет нет, зато искусственные спутники были
# были запущены на круговые орбиты. Результатом функции должен быть кортеж,
# содержащий длины полуосей эллипса орбиты самой далекой планеты. Каждая
# орбита представляет из себя кортеж из пары чисел - полуосей ее эллипса.
...
def exclude_item(list_1):
   return [i for i in orbits if i[0] != i[1]]

# def find_max_elips(list_1):
#     max_1 = list_1[0][0] * list_1[0][1];
#     for i in  range (len(list_1)):
#         temp_max = list_1[i][0] * list_1[i][1]
#         if temp_max > max_1:
#             max_1 = temp_max;
#             res = list_1[i]
#     return res;
def find_farthest_orbit(list_1):
    list_1 = max ([ (i[0] * i[1], i )for i in list_1 ])[1];
    return list_1;

orbits = [(1, 3), (2.5, 10), (7, 2), (6, 6), (4, 3)] 
print (*find_farthest_orbit(exclude_item (orbits)))